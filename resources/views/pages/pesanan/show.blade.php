    ...
    <div class="main">
        <div class="container-fluid">
            <div class="card mt-4">
                ...
                <div class="row">
                    <div class="col">
                        <h6>{{ $pesanan->siswa->nama }} - {{ $pesanan->siswa->nis }}</h6>
                        <h6>{{ $pesanan->siswa->email }}</h6>
                        <h6>{{ $pesanan->siswa->telp }}</h6>
                        <h6>{{ $pesanan->siswa->sekolah->nama_sekolah }} - {{ $pesanan->siswa->kelas->kode_kelas }}</h6>
                    </div>
                            ...
                            <table class="table text-center table-bordered mb-4">
                                ...
                                <tbody>
                                    @foreach ($pesanan->pesananDetail as $p)
                                        <tr>
                                            <td>
                                                <img style="width: 200px" src="{{ url('storage/' . $p->buku->sampul) }}" class="img-fluid">
                                            </td>
                                    ...
                                    <tr>
                                        <th>Ongkos Kirim</th>
                                        <td class="text-center">@convert($pesanan->ongkir) <br> {{ $pesanan->ekspedisi }}</td>
                                    </tr>
                    ...
                    <div class="row mt-4">
                        <div class="col">
                            <form action="{{ route('admin.pesanan.update', $pesanan->id) }}" method="POST">
                                ...
                                <input type="hidden" name="sekolah_id" value="{{ $pesanan->siswa->sekolah->id }}">
            ...
            @if ($konfirmasi)
                    <div class="card mt-4">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-4">
                                <img src="{{ url('storage/' . $pesanan->konfirmasiPesanan->bukti_transfer) }}" class="img-fluid">
                            </div>
                        </div>
                    </div>
            @endif
